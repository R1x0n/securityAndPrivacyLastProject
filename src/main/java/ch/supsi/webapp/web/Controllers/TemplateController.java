...
import ch.supsi.webapp.web.Utilities.*;
...
public class TemplateController {
    ...
    public String home(Model model) {
        ...
        model.addAttribute("user", UserConverter.getUser(SecurityContextHolder.getContext().getAuthentication().getPrincipal()));
        return "allCustomers";
    }

    @RequestMapping(value = "/app", method = RequestMethod.GET)
    public String personalCustomers(Model model) {
        List<ICustomer> customers = costumerRepository.getPersonalCustomersInterface(UserConverter.getUser(SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getEmployeeId());
    ...
    public String registerPost(@RequestParam("current") String current, @RequestParam("new") String newPass, @RequestParam("confirm") String confirm, Model model) throws SQLException, IOException {
        Employee user = UserConverter.getUser(SecurityContextHolder.getContext().getAuthentication().getPrincipal());
        ...
        if (validatePassword(newPass)) {
            if (newPass.equals(confirm)) {
                if (encoder.matches(current, password)) {
                    ...
                    UtilLogger.info("Changed password");
